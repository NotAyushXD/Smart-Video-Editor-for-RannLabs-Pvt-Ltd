...
browse = Button(mainWindow, image = browseImage, text = "Browse", font = fontButtons, bg = white, width = 100, height= 80, command=browse_file)
browse.place(x=350,y=425)
...
def load_videos(video_file):
  ...
  grid = Button(mainWindow, text = "GRID THEN PLAY", font = fontButtons, bg = white, width = 20, height= 1,command = grid)

  grid.place(x=520,y=400)

  grid = Button(mainWindow, text = "DRAW", font = fontButtons, bg = white, width = 20, height= 1,command = draw)

  grid.place(x=30,y=400)
  play = Button(mainWindow,image = playImage ,text = "PLAY", font = fontButtons, bg = white, width = 80, height= 80, command=play)
  ...
  pause = Button(mainWindow, image = pauseImage, text = "PAUSE", font = fontButtons, bg = white, width = 80, height= 80, command=pause)
  ...
  textBox.place(x=340,y=537)

  app = my_app(mainWindow)
  main_button = Button(mainWindow,text="Submit",image = submitImage, command=lambda:add_button()).place(x=370,y=560)
